...
class Users(db.Model, UserMixin):
    ...
    # Добавляем сразу 2 функции для паролей, чтобы не использовать их явно при регистрации пользователя.
    # Облегчает это жизнь.
...
class OperationAddForm(FlaskForm):
...
class OperationFindForm(FlaskForm):
